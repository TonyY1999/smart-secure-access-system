...
#define READ_INDEX_CMD		{0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00, 0x04, 0x1F, 0x00, 0x24};
...
/**
 * @brief Delete a stored fingerprint template by ID.
 * @details Sends the DELETE command to the sensor.
 * @param[in] id ID of the fingerprint to delete.
 * @return 0 on success, -1 on failure.
 */
